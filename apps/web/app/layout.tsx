...
const SITE_URL =
  ...
  "https://casalolives.concierge.studio";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: "Casal Olives — single-estate Mġarr olive oil",
    template: "%s — Casal Olives",
  },
  description:
    "Single-estate Mġarr olive oil — Verde, Maturo, Riserva. Plus a Saturday tasting at the grove. Concept site by concierge.studio.",
  alternates: { canonical: "/" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  other: { "robots": "index,follow,noai" },
  openGraph: {
    type: "website",
    siteName: "Casal Olives",
    images: [{ url: "/og-default.png", width: 1200, height: 630, alt: "Casal Olives" }],
  },
